...
::: {.callout-tip title="Session Recording and Presentation Slides"}
[Session Recording](https://umn.zoom.us/rec/play/f4AhmblWimh4ebiMjwL4oneVqFN4-tLQxHJ5QGls0uw0vcvmlC455e9ennGBaZWgGE3PYbnjFT-XO_qr.bg4CFNbA0FErVNov?canPlayFromShare=true&from=share_recording_detail&startTime=1712937926000&componentName=rec-play&originRequestUrl=https%3A%2F%2Fumn.zoom.us%2Frec%2Fshare%2FEa0vevsJsx5DVZG9_f9pYuJPIYyfN5xHRTGHc37YaISvB1KPm7IYj17EEmLfB8Z4.TxaHMD0vsURAnZ1t%3FstartTime%3D1712937926000)

[Presentation Slides](https://www.nicholaspolimeni.com/resources/presentation.html)
:::
...
::: {.callout-tip title="Application to Research"}
We utilized this method to create a straightforward framework quantifying equity loss from communities due to institutional investors [@jua].
...
![Relative equity loss due to SFRs in Atlanta's Neighborhood Statistical Areas [@jua].](equity_loss.png)
:::
...
Appendix C of [@jua] contains this data for Fulton County, GA.
:::
...
![Table of all ownership possibilities [@acsp]](possibilities.png)
